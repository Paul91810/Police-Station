  ...
  Future pickImage({required context}) async {
    try {
      ...
      Provider.of<DocumentController>(context, listen: false)
          .changePickedFile(imageTemp);
      final val = Provider.of<DocumentController>(context, listen: false).bools;
      final pickedData = Provider.of<DocumentController>(context, listen: false)
          .pickedDocument;

      Provider.of<DocumentController>(context, listen: false)
          .changeBool(pickedData.path.isEmpty
              ? val
                  ? false
                  : true
              : true);
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Consumer<DocumentController>(builder: (context, myModel, ch) {
                // log(myModel.pickedDocument.toString());
                return myModel.bools
                    ? Container(
                        color: Colors.black,
                        width: 50,
                        height: 50,
          ...
          ElevatedButton(onPressed: () {}, child: const Text("Send  Summons")),
        ],
      ),
    );
  }
...
Future<void> fineNotPaid(BuildContext context) async {
  showDialog(
    context: context,
    builder: (ctx) {
      return SimpleDialog(children: [FileAttachment()]);
    },
  );
}
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MyWidget2(name: "Owner Name :", width: 35, sacondNmae: "1"),
                  MyWidget2(name: "Reg Auth :", width: 59, sacondNmae: "1"),
                  MyWidget2(name: "Vec Class :", width: 57, sacondNmae: "1"),
                  MyWidget2(name: "Rc Status :", width: 57, sacondNmae: "1"),
                  MyWidget2(name: "Fuel Type :", width: 57, sacondNmae: "1"),
                  ...
                  MyWidget2(
                      ...
                      sacondNmae: "1"),
                  MyWidget2(
                      name: "Tax Valid\nUpTo", width: 70, sacondNmae: "1"),
                  MyWidget2(
                      name: "PUCC Valid\nUpTo", width: 58, sacondNmae: "1"),
                  Center(
                      child: ElevatedButton(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MyWidget2(name: "Owner Name :", width: 60, sacondNmae: "1"),
                  MyWidget2(name: "House name :", width: 62, sacondNmae: "1"),
                  MyWidget2(name: "Street :", width: 104, sacondNmae: "1"),
                  MyWidget2(name: "Pincode :", width: 92, sacondNmae: "1"),
                  MyWidget2(name: "District :", width: 98, sacondNmae: "1"),
                  MyWidget2(name: "DOB", width: 125, sacondNmae: "1"),
                  MyWidget2(name: "Valid form", width: 88, sacondNmae: "1"),
                  MyWidget2(name: "Valid to", width: 106, sacondNmae: "1"),
                  MyWidget2(name: "Vehicle class", width: 73, sacondNmae: "1"),
                  MyWidget2(
