  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
          child: AppBar12(title: "Fine ", autoAppbar: false),
                      ...
                      if (snapshot.hasData) {
                        return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return finePayWidget(
                                name: modelVal.name.toString(),
                                ...
                                onTap: () {
                                  openCheckout(modelVal.amount != null
                                      ? int.parse(modelVal.amount.toString())
                                      : 00);
                                });
                          },
                        );
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              MyText2(name1: "Offense:", width: 108, name2: offense),
              MyText2(name1: "Amount:", width: 108, name2: amount),
              MyText2(
                  name1: "Type of Transaction:",
                  width: 35,
                  name2: typeOfTransfer),
            ],
          ),
        ),
        Container(
