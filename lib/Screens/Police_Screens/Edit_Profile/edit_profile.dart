                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ElevatedButton(
                          onPressed: () {
                            if (myModel.phoneNumber == null &&
                                myModel.name == null &&
                                myModel.phoneNumber == null &&
                                myModel.stationAdd == null) {
                              return;
                            }
                            if (myModel.phoneNumber!.isNotEmpty &&
                                myModel.name!.isNotEmpty &&
                                myModel.pinNumber!.isNotEmpty &&
                                myModel.stationAdd!.isNotEmpty) {
